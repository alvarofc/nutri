...
export const ui = {
  en: {
    ...
    'home.description': 'I help you achieve your health and wellness goals through personalized nutrition plans.',
    ...
    'services.step1.description': 'My goal is to get to know you, understand your current situation and what you want to achieve.',
    'services.step2.name': 'Plan',
    'services.step2.description': 'I will develop a customized plan for you and your goals. We will review it together to ensure you understand it and feel comfortable with it.',
    'services.step3.name': 'Follow-up',
    'services.step3.description': 'We will follow up to see how you are doing and, if necessary, adjust the plan to ensure it remains effective.',
    
    // About page
    'about.title': 'About me',
    'about.subtitle': 'Find information about my story, values, goals and more.',
    'about.section.title': 'About me',
    'about.heading.title': 'About Alexandra',
    'about.heading.subtitle': 'Passion for health and results.',
    'about.mission.title': 'My mission',
    'about.mission.paragraph1': 'From a very young age, I knew that my passion was helping people through health. That is why I worked hard to achieve academic excellence and thus be able to access a career that would allow me to fulfill my dream. After high school, where I obtained the best average in my center and honors, I began my degree in Biomedical Sciences at the Autonomous University of Barcelona.',
    ...
    'about.team.member2.name': 'Emma Dorsey',
    ...
    'expertise.maternity.desc': 'Specialized nutrition plans for mothers before, during, and after pregnancy to ensure optimal health for both mother and baby.',
    'expertise.diabetes': 'Diabetes',
    'expertise.diabetes.desc': 'Personalized dietary strategies to manage blood sugar levels and improve quality of life for those with diabetes.',
    'expertise.renal': 'Renal',
    'expertise.renal.desc': 'Specialized nutrition plans for those with kidney conditions to maintain kidney function and overall health.',
    'expertise.oncology': 'Oncology',
    'expertise.oncology.desc': 'Supportive nutrition strategies for cancer patients to maintain strength during treatment and recovery.',
    'expertise.eating': 'Eating Disorders',
    'expertise.eating.desc': 'Compassionate and evidence-based nutrition therapy for those recovering from eating disorders.',
    'expertise.weight': 'Weight Management',
    'expertise.weight.desc': 'Sustainable weight management strategies focused on health improvement rather than just numbers on a scale.',
  ...
  es: {
    ...
    'home.description': 'Te ayudo a alcanzar tus objetivos de salud y bienestar a través de planes de nutrición personalizados.',
    ...
    'services.step1.description': 'Mi objetivo es conocerte, saber cuál es tu situación actual y qué es lo que quieres conseguir.',
    'services.step2.name': 'Plan',
    'services.step2.description': 'Desarrollaré un plan hecho a medida para tí y tus objetivos. Lo repasaremos juntos para asegurarnos de que lo entiendes y te sientes cómodo con él.',
    'services.step3.name': 'Seguimiento',
    'services.step3.description': 'Realizaremos un seguimiento para ver cómo te encuentras y si es necesario, ajustaremos el plan para que siga siendo efectivo.',
    
    // About page
    'about.title': 'Sobre mí',
    'about.subtitle': 'Conoce más sobre mi enfoque de la nutrición',
    'about.section.title': 'Sobre mí',
    'about.heading.title': 'Sobre Alexandra',
    'about.heading.subtitle': 'Pasión por la salud y los resultados.',
    'about.mission.title': 'Mi misión',
    'about.mission.paragraph1': 'Desde muy pequeña he sabido que mi pasión es ayudar a las personas mediante la salud. Por eso, me esforcé al máximo para poder obtener excelencia académica y así poder acceder a una carrera que me permitiera cumplir mi sueño. Tras el bachillerato, donde obtuve la mejor media de mi centro y matrícula de honor, empecé la carrera de Ciencias Biomédicas en la Universidad Autónoma de Barcelona.',
    ...
    'contact.form.submit': 'Contactar',
    'contact.form.error.name': 'Por favor, introduce tu nombre.',
    'contact.form.error.email': 'Email no válido.',
    ...
    'expertise.maternity.desc': 'Planes de nutrición especializados para madres antes, durante y después del embarazo para garantizar una salud óptima tanto para la madre como para el bebé.',
    'expertise.diabetes': 'Diabetes',
    'expertise.diabetes.desc': 'Estrategias dietéticas personalizadas para controlar los niveles de azúcar en sangre y mejorar la calidad de vida de las personas con diabetes.',
    'expertise.renal': 'Renal',
    'expertise.renal.desc': 'Planes de nutrición especializados para personas con afecciones renales para mantener la función renal y la salud general.',
    'expertise.oncology': 'Oncológico',
    'expertise.oncology.desc': 'Estrategias nutricionales de apoyo para pacientes con cáncer para mantener la fuerza durante el tratamiento y la recuperación.',
    'expertise.eating': 'Trastorno de la Conducta Alimentaria',
    'expertise.eating.desc': 'Terapia nutricional compasiva y basada en evidencia para aquellos que se recuperan de trastornos alimentarios.',
    'expertise.weight': 'Adelgazamiento',
    'expertise.weight.desc': 'Estrategias sostenibles de control de peso centradas en la mejora de la salud más que en números en una báscula.',
    
    // 404 page
    '404.title': 'Página no encontrada',
    '404.description': 'Por favor, comprueba la URL en la barra de direcciones e inténtalo de nuevo.',
